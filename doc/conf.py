...
# -*- coding: utf-8 -*-
#
# nikamap documentation build configuration file, created by
...
project = 'nikamap'
copyright = '2017, Alexandre Beelen'
...
latex_documents = [
    ('index', 'nikamap.tex', 'nikamap Documentation',
     'Alexandre Beelen', 'manual'),
]
...
man_pages = [
    ('index', 'nikamap', 'nikamap Documentation',
     ['Alexandre Beelen'], 1)
]
...
texinfo_documents = [
    ('index', 'nikamap', 'nikamap Documentation',
     'Alexandre Beelen', 'nikamap', 'One line description of project.',
     'Miscellaneous'),
]
